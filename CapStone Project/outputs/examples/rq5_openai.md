...
- Parsed references: 5
- Reference validation: {'unverified': 1, 'api_unavailable': 4}
- Claim verification: {'insufficient_evidence': 2}
...
### Sentence 11 — insufficient_evidence
...
- Tokens: input `441`, output `65`, total `506`
- Response ID: `resp_0a863bc2e873adc4016a4647a37928819c841521e9e0c2b000`

Rationale: The evidence identifies RAG papers, including a survey and the original 2020 work, but does not explicitly state that RAG connects a language model to external knowledge without changing model weights.
